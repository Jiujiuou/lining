...
function ControlsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-left", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--controls", "aria-label": "控制区", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-controls-page-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "shop-rate-open", className: "popup-open-sites", children: "店铺分" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "alimama-open", className: "popup-open-sites", children: "淘宝联盟" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "onebp-open", className: "popup-open-sites", children: "万象台1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "onebp-display-open", className: "popup-open-sites", children: "万象台2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "onebp-site-open", className: "popup-open-sites", children: "万象3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "onebp-shortvideo-open", className: "popup-open-sites", children: "万象4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "sycm-my-space-open", className: "popup-open-sites", children: "千牛后台" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "report-submit-open", className: "popup-open-sites", children: "上报页" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-controls-action-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "open-all-pages", className: "popup-open-sites popup-open-all", children: "一键打开所有页面" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "metrics-date", className: "popup-metrics-inline-date", children: "--" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function LogsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--logs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-logs-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "logs-clear", className: "popup-logs-clear", "aria-label": "清空日志", children: "清空" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "logs-list", className: "popup-logs-list", role: "log", "aria-live": "polite" })
  ] });
}
const ONEBP_SEARCH_BASE = "https://one.alimama.com/index.html#!/manage/search?mx_bizCode=onebpSearch&bizCode=onebpSearch&tab=campaign";
const ONEBP_DISPLAY_BASE = "https://one.alimama.com/index.html#!/manage/display?mx_bizCode=onebpDisplay&bizCode=onebpDisplay&tab=campaign";
const ONEBP_SITE_BASE = "https://one.alimama.com/index.html#!/manage/onesite?mx_bizCode=onebpSite&bizCode=onebpSite&tab=campaign";
const ONEBP_SHORTVIDEO_BASE = "https://one.alimama.com/index.html#!/manage/content?mx_bizCode=onebpShortVideo&bizCode=onebpShortVideo&tab=campaign";
...
function formatMetricCell(snap, item) {
  ...
  const has = raw !== void 0 && raw !== null && String(raw).replace(/\s/g, "") !== "";
  return has ? escHtml(String(raw)) : "—";
}
function buildDailyMetricsHtml(snap) {
  if (!snap || typeof snap !== "object") {
  ...
  for (let i = 0; i < n; i += 1) {
    ...
    parts.push(
      `<div class="popup-metric-grid-row ${zebra}"><span class="popup-metric-cell popup-metric-cell--label">${left && left.label ? escHtml(left.label) : ""}</span><span class="popup-metric-cell popup-metric-cell--value">${formatMetricCell(snap, left)}</span><span class="popup-metric-cell popup-metric-cell--spacer" aria-hidden="true"></span><span class="popup-metric-cell popup-metric-cell--label">${right && right.label ? escHtml(right.label) : ""}</span><span class="popup-metric-cell popup-metric-cell--value">${formatMetricCell(snap, right)}</span></div>`
    );
  }
  return `<div class="popup-metrics-grid" role="table" aria-label="本地合并指标">${parts.join("")}</div>`;
}
function pickDailySnapshotFromBag(bag) {
  const ymd = yesterdayYmd();
...
function initLegacyPopup() {
  ...
  (function() {
    ...
    var defaults = typeof __SHOP_RECORD_DEFAULTS__ !== "undefined" ? __SHOP_RECORD_DEFAULTS__ : null;
    var shopRateUrl = defaults && defaults.SHOP_RATE_PAGE_URL ? defaults.SHOP_RATE_PAGE_URL : "https://rate.taobao.com/user-rate-UvCIYvCxbMCcGvmHuvQTT.htm?spm=a1z10.1-b.d4918101.1.7b716fe7xfRnm3";
    var alimamaUrl = defaults && defaults.ALIMAMA_DASHBOARD_URL ? defaults.ALIMAMA_DASHBOARD_URL : "https://ad.alimama.com/portal/v2/dashboard.htm";
    var sycmMySpaceUrl = defaults && defaults.SYCM_MY_SPACE_URL ? defaults.SYCM_MY_SPACE_URL : "https://sycm.taobao.com/adm/v3/my_space?_old_module_code_=adm-eportal-order-experience-transit&_old_module_expiration_=1773970265356&activeKey=common&tab=fetch";
    var reportSubmitPageUrl = defaults && defaults.REPORT_SUBMIT_PAGE_URL ? defaults.REPORT_SUBMIT_PAGE_URL : "https://oa1.ilanhe.com:8088/spa/workflow/static4form/index.html?_rdm=1774403128141#/main/workflow/req?iscreate=1&workflowid=1663&isagent=0&beagenter=0&f_weaver_belongto_userid=&f_weaver_belongto_usertype=0&menuIds=1,12&menuPathIds=1,12&preloadkey=1774403128141&timestamp=1774403128141&_key=ldyx2e";
    function getAllPageUrls$1() {
      return getAllPageUrls({
        shopRateUrl,
        alimamaUrl,
        sycmMySpaceUrl,
        reportSubmitPageUrl
    ...
    function initShopRecordMain() {
      ...
      var PREFIX = defaults && defaults.PREFIX ? defaults.PREFIX : "[店铺记录数据]";
      var FILL_REPORT_PAGE_MSG = defaults && defaults.RUNTIME && defaults.RUNTIME.FILL_REPORT_PAGE_MESSAGE ? defaults.RUNTIME.FILL_REPORT_PAGE_MESSAGE : "SR_FILL_REPORT_PAGE";
      var STORAGE_DAILY = defaults && defaults.STORAGE_KEYS && defaults.STORAGE_KEYS.dailyLocalByDate ? defaults.STORAGE_KEYS.dailyLocalByDate : "shop_record_daily_local_by_date";
      ...
      function runReportSubmitFillAfterPermission() {
        if (!defaults || typeof defaults.pickSnapshotFromDailyBag !== "function" || typeof defaults.validateReportSnapshotForFill !== "function") {
          if (logger) {
        ...
        chrome.storage.local.get([STORAGE_DAILY], function(result) {
          ...
          chrome.runtime.sendMessage({ type: FILL_REPORT_PAGE_MSG }, function(res) {
            if (chrome.runtime.lastError) {
              ...
              if (logger) {
                logger.log(
                  PREFIX + " 自动填充成功：已写入 " + (res.filled != null ? res.filled : "?") + " 项（统计日 " + (res.reportAt || "") + "）"
                );
              }
            } else {
              if (logger) {
                var errMsg = res && res.error === "incomplete_data" ? "本地数据不完整（共 " + (res.missingCount != null ? res.missingCount : "?") + " 项缺失）" : res && res.error ? String(res.error) : "未知原因（请确认上报页已加载）";
      ...
      function openAllPages() {
        getAllPageUrls$1().forEach(function(url) {
...
function usePopupAutoRefresh() {
  usePopupAutoRefresh$1({ runtimeKey: "__SHOP_RECORD_POPUP_RUNTIME__" });
}
...
function usePopupLogSync() {
  usePopupLogSync$1({ runtimeKey: "__SHOP_RECORD_POPUP_RUNTIME__" });
}
...
function usePopupStorageSync() {
  usePopupStorageSync$1({ runtimeKey: "__SHOP_RECORD_POPUP_RUNTIME__" });
}
...
function usePopupDomEvents() {
  ...
  usePopupDomEvents$1(bindingList, { runtimeKey: "__SHOP_RECORD_POPUP_RUNTIME__" });
}
function PopupPage() {
  ...
  usePopupStorageSync();
  usePopupDomEvents();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "app-main", className: "popup", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlsSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogsSection, {}) })
  ] });
}
function mountPopup() {
  const container = document.getElementById("root");
  if (!container) {
    console.error("[Rext][extension-shop-record] 未找到 #root，Popup 挂载失败");
    return;
  }

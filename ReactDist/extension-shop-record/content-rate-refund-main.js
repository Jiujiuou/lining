(function() {
  "use strict";
  function initContentRateRefundMain() {
    ...
    (function() {
      ...
      function fetchRefundScript(urlStr) {
        ...
        fetch(urlStr, { method: "GET", credentials: "include" }).then(function(r) {
          return r.text();
        }).then(function(t) {
          handleText(urlStr, t);
        }).catch(function() {
      ...
      Element.prototype.setAttribute = function(name, value) {
        if (this.tagName === "SCRIPT" && String(name).toLowerCase() === "src" && isRefundIndexUrl(value)) {
...
//# sourceMappingURL=content-rate-refund-main.js.map

...
const amcrLogger = createTabLogService({
...
globalThis.__AMCR_LOGGER__ = amcrLogger;
const MAX_DAYS = 1;
...
function QuickOpenSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "popup-section popup-section--quick-open", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-quick-open-row", role: "group", "aria-label": "搜索词、日期与推广页", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-nav-cal-wrap dashboard-cal-inline", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dashboard-cal-anchor", id: "popup-nav-cal-anchor", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "search-keyword-apply", className: "popup-search-keyword-apply", children: "应用" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "open-onesite-record", className: "popup-open-sites", children: "货品全站" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "open-search-record", className: "popup-open-sites", children: "关键词" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "open-promo-record", className: "popup-open-sites", children: "人群" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "open-content-record", className: "popup-open-sites", children: "内容营销" })
  ] }) });
}
function LocalRegisterSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "popup-section popup-section--local-register", id: "amcr-local-register-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      id: "amcr-local-table-wrap",
      className: "popup-local-table-wrap",
      role: "region",
      "aria-label": "本地推广登记表"
    }
  ) });
...
function FindPageSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-findpage-split", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "popup-section popup-section--findpage-list", "aria-label": "推广捕获列表", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "findpage-list", className: "popup-findpage-list", role: "list" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "popup-section popup-section--findpage-toolbar", "aria-label": "列表操作", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "popup-findpage-actions", role: "toolbar", "aria-label": "列表操作", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "findpage-action", className: "popup-action-btn", children: "登记" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "findpage-refresh", className: "popup-action-btn", "aria-label": "刷新列表", children: "刷新列表" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "amcr-local-export", className: "popup-action-btn", "aria-label": "导出表格", children: "导出表格" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function RightPanelSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--storage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-storage-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-storage-progress-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-storage-progress", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "storage-usage-bar", className: "popup-storage-progress-bar" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "storage-usage-percent", className: "popup-storage-percent", children: "0.0%" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "storage-usage", className: "popup-storage-usage", children: "加载中..." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--logs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-logs-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "popup-logs-title", children: "日志" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "logs-clear", className: "popup-logs-clear", "aria-label": "清空日志", children: "清空日志" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "logs-list", className: "popup-logs-list", role: "log", "aria-live": "polite" })
    ] })
  ] });
}
...
function pruneSelectionStore(store, limits) {
  const src = store && typeof store === "object" ? store : {};
  const next = {};
  const maxQueries = 100;
  const maxQueriesPerPage = 25;
  const maxItemsPerQuery = 200;
  ...
  for (let i = 0; i < keys.length; i += 1) {
    ...
    next[key] = {
      ...
      pageType,
      lastTouchedAt: item.lastTouchedAt || (/* @__PURE__ */ new Date()).toISOString()
    };
...
function getReportDate(item, todayYmd) {
...
function displayMoneyCell(value) {
  if (value == null || typeof value !== "number" || Number.isNaN(value)) return "";
  return value === 0 ? "" : value.toFixed(2);
}
function displayRoiCell(charge, amount) {
...
function initLegacyPopup() {
  ...
  document.getElementById("open-promo-record");
  document.getElementById("open-onesite-record");
  document.getElementById("open-search-record");
  document.getElementById("open-content-record");
  var searchKeywordInput = document.getElementById("search-keyword-input");
  document.getElementById("search-keyword-apply");
  var findpageListEl = document.getElementById("findpage-list");
  document.getElementById("findpage-action");
  document.getElementById("findpage-refresh");
  document.getElementById("amcr-local-export");
  var amcrLocalTableWrap = document.getElementById("amcr-local-table-wrap");
  document.getElementById("amcr-local-clear");
  ...
  document.getElementById("storage-cache-clear");
  ...
  var navCalDatesWithData = /* @__PURE__ */ new Set();
  var currentNavDateYmd = "";
  var STORAGE_LOCAL = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.localRegisterByDate ? __AMCR_DEFAULTS__.STORAGE_KEYS.localRegisterByDate : "amcr_local_register_by_date";
  var STORAGE_SELECTION_BY_QUERY = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.findPageSelectionByQuery ? __AMCR_DEFAULTS__.STORAGE_KEYS.findPageSelectionByQuery : "amcr_findPageSelectionByQuery";
  var STORAGE_LOGS = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.logs ? __AMCR_DEFAULTS__.STORAGE_KEYS.logs : "amcr_logs";
  var STORAGE_LOGS_BY_TAB = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.logsByTab ? __AMCR_DEFAULTS__.STORAGE_KEYS.logsByTab : "amcr_logs_by_tab";
  ...
  var STORAGE_NAV_DATE = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.popupNavDate ? __AMCR_DEFAULTS__.STORAGE_KEYS.popupNavDate : "amcr_popup_nav_date";
  typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_QUERIES ? __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_QUERIES : 100;
  typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_QUERIES_PER_PAGE ? __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_QUERIES_PER_PAGE : 25;
  var SELECTION_MAX_ITEMS_PER_QUERY = typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_ITEMS_PER_QUERY ? __AMCR_DEFAULTS__.FIND_PAGE_SELECTION_MAX_ITEMS_PER_QUERY : 200;
  var BIZ_TO_KEYS = {
  ...
  function isQuotaError2(err) {
    if (!err) return false;
    return /quota|QUOTA_BYTES|Resource::kQuotaBytes/i.test(String(err.message || err));
  }
  function safeSet2(payload, onDone, onQuota) {
    chrome.storage.local.set(payload, function() {
      if (chrome.runtime && chrome.runtime.lastError && isQuotaError2(chrome.runtime.lastError) && typeof onQuota === "function") {
        onQuota(function() {
          chrome.storage.local.set(payload, function() {
  ...
  function getStateByTabKey() {
    return typeof __AMCR_DEFAULTS__ !== "undefined" && __AMCR_DEFAULTS__.STORAGE_KEYS && __AMCR_DEFAULTS__.STORAGE_KEYS.findPageStateByTab ? __AMCR_DEFAULTS__.STORAGE_KEYS.findPageStateByTab : "amcr_findPageStateByTab";
  }
  ...
  function getYesterdayEast8() {
    var today = (/* @__PURE__ */ new Date()).toLocaleDateString("sv-SE", { timeZone: "Asia/Shanghai" });
    var d = /* @__PURE__ */ new Date(today + "T12:00:00+08:00");
  ...
  function renderNavCalendarPopoverInnerHTML() {
    ...
    parts.push(
      '<span class="dashboard-cal-title">' + navCalView.y + " 年 " + (navCalView.m0 + 1) + " 月</span>"
    );
    parts.push(
    ...
    cells.forEach(function(cell, idx) {
      ...
      parts.push(
        '<button type="button" class="' + cls + '" data-nav-cal-day="' + escAttr(c.ymd) + '"' + (c.disabled ? " disabled" : "") + '><span class="dashboard-cal-cell-num">' + dayNum + "</span>" + (c.hasData ? '<span class="dashboard-cal-cell-dot" aria-hidden="true"></span>' : "") + "</button>"
      );
    });
    parts.push("</div>");
    return parts.join("");
  ...
  function refreshNavCalDatesWithData(callback) {
    if (typeof chrome === "undefined" || !chrome.storage || !chrome.storage.local) {
      navCalDatesWithData = /* @__PURE__ */ new Set();
  ...
  function renderFindPageList(response, bizCode, selectedSet) {
    ...
    if (list.length === 0) {
      findpageListEl.innerHTML = '<div class="popup-findpage-list--empty"><span>暂无捕获数据，请先在推广页面打开列表</span></div>';
    ...
    findpageListEl.innerHTML = list.map(function(item, index) {
      ...
      return '<div class="popup-findpage-item' + statusClass + '" role="listitem"' + titleAttr + '><input type="checkbox" id="findpage-cb-' + index + '" data-index="' + index + '" aria-label="勾选 ' + safeName + '"' + checkedAttr + '><label class="popup-findpage-name" for="findpage-cb-' + index + '">' + safeName + "</label></div>";
    }).join("");
  }
  ...
  function displayRatioChargeManual(totalCharge, manualAmt) {
    ...
    var m = typeof manualAmt === "number" && !Number.isNaN(manualAmt) ? manualAmt : parseManualTotalInput(String(manualAmt));
  ...
  function pickLocalRegisterDay(bag, ymd) {
    ...
    if (ymd && bag[ymd] && typeof bag[ymd] === "object") return { ymd, day: bag[ymd] };
  ...
  function renderLocalRegisterTable(bag) {
    ...
    if (!ymd || !day || !day.byBiz || typeof day.byBiz !== "object") {
      amcrLocalTableWrap.innerHTML = '<div class="popup-local-table--empty">暂无本地登记数据</div>';
      return;
    }
    var wideRows = pivotLocalDayToWideRows(day);
    var manualMap = day.manual_total_amt_by_name && typeof day.manual_total_amt_by_name === "object" ? day.manual_total_amt_by_name : {};
    if (!wideRows.length) {
      amcrLocalTableWrap.innerHTML = '<div class="popup-local-table--empty">暂无本地登记数据</div>';
      return;
    }
    ...
    parts.push(
      "<th>日期</th><th>推广名称</th><th>关键词消耗</th><th>关键词成交</th><th>关键词ROI</th><th>人群消耗</th><th>人群成交</th><th>人群ROI</th><th>全站消耗</th><th>全站成交</th><th>全站ROI</th><th>内容消耗</th><th>内容成交</th><th>内容ROI</th><th>总消耗</th><th>总推广成交</th><th>总成交金额</th><th>比例</th><th>操作</th>"
    );
    ...
    wideRows.forEach(function(wr) {
      ...
      var payload = escAttr(JSON.stringify({ ymd, name }));
      var totalCharge = toNum(m.charge_onebpsearch) + toNum(m.charge_onebpdisplay) + toNum(m.charge_onebpsite) + toNum(m.charge_onebpshortvideo);
      var totalAmt = toNum(m.alipay_inshop_amt_onebpsearch) + toNum(m.alipay_inshop_amt_onebpdisplay) + toNum(m.alipay_inshop_amt_onebpsite) + toNum(m.alipay_inshop_amt_onebpshortvideo);
      ...
      parts.push(
        '<td class="popup-local-num popup-local-cell-edit popup-local-cell-total-amt"><input type="text" inputmode="decimal" autocomplete="off" spellcheck="false" size="10" class="popup-local-total-amt-input" data-ymd="' + escAttr(ymd) + '" data-name="' + escAttr(name) + '" value="' + escAttr(manualToInputValue(manualStored)) + '" /></td>'
      );
  ...
  function saveManualTotalAmt(ymd, campaignName, raw) {
    ...
    chrome.storage.local.get([STORAGE_LOCAL], function(result) {
      ...
      day.updated_at_local = (/* @__PURE__ */ new Date()).toISOString();
      bag[ymd] = day;
      var out = {};
      out[STORAGE_LOCAL] = bag;
      safeSet2(out, function() {
  ...
  function tableToExcelHtml(tableEl) {
    ...
    return '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><meta charset="UTF-8"></head><body>' + clone.outerHTML + "</body></html>";
  }
  ...
  function onFindPageAction() {
    ...
    chrome.tabs.query(ACTIVE_TAB_QUERY, function(tabs) {
      ...
      var selectedDisplayNames = rows.map(function(r2) {
        return r2.campaign_name;
      });
      var queryState = {
      ...
      if (localApi && typeof localApi.mergeRegisterBatch === "function") {
        localApi.mergeRegisterBatch(
          { report_date: batchReportDate, biz_code: bizCode, rows },
          function() {
            loadLocalRegisterTable();
            if (logger) {
    ...
    chrome.storage.local.get(
      ...
      function(s) {
        queryActiveTabId(function(tabId) {
          ...
          logger.appendLog(
            "log",
            n > 0 ? "列表已刷新：" + n + " 条（" + bizLabel(pack.state.findPageBizCode || "") + "）" : "暂无可用列表，请先在推广页面打开列表"
          );
          loadLogs();
        });
      }
  ...
  function handleStorageChanged(changes, areaName) {
    ...
    if (changes[STORAGE_LOCAL] || changes[STORAGE_LOGS] || changes[STORAGE_LOGS_BY_TAB] || changes[STORAGE_SELECTION_BY_QUERY] || changes.amcr_findPageResponse || changes.amcr_findPageRequestUrl || changes.amcr_findPagePageUrl || changes.amcr_findPageBizCode || changes.amcr_findPageSelectedCampaigns) {
      refreshAll();
    }
  }
  ...
  globalThis.__AMCR_POPUP_RUNTIME__ = {
    ...
    handleFindPageRefreshClick,
    handleSearchKeywordKeydown,
    handleLocalTableClick,
    handleLocalTableBlur,
    handleNavDateTriggerClick,
    handleNavCalendarClick,
    refreshOnFocus,
    startAutoRefresh,
    stopAutoRefresh
  };
}
function useLegacyPopupBootstrap() {
...
function getPopupRuntime(runtimeKey = "__AMCR_POPUP_RUNTIME__") {
  if (!runtimeKey) {
    return null;
  }
  return globalThis[runtimeKey] || null;
}
function usePopupAutoRefresh$1(options = {}) {
...
function usePopupAutoRefresh() {
  usePopupAutoRefresh$1({ runtimeKey: "__AMCR_POPUP_RUNTIME__" });
}
function usePopupLogSync$1(options = {}) {
  const runtimeKey = options.runtimeKey || "__AMCR_POPUP_RUNTIME__";
  reactExports.useEffect(() => {
    const runtime = getPopupRuntime(runtimeKey);
    ...
    refreshLogs();
    const timer = setInterval(refreshLogs, 15e3);
...
function usePopupLogSync() {
  usePopupLogSync$1({ runtimeKey: "__AMCR_POPUP_RUNTIME__" });
}
function usePopupStorageSync$1(options = {}) {
  const runtimeKey = options.runtimeKey || "__AMCR_POPUP_RUNTIME__";
  reactExports.useEffect(() => {
...
function usePopupStorageSync() {
  usePopupStorageSync$1({ runtimeKey: "__AMCR_POPUP_RUNTIME__" });
}
...
function usePopupDomEvents$1(bindingList, options = {}) {
  const runtimeKey = options.runtimeKey || "__AMCR_POPUP_RUNTIME__";
  reactExports.useEffect(() => {
    const runtime = getPopupRuntime(runtimeKey);
...
function usePopupDomEvents() {
  const bindingList = reactExports.useMemo(() => [
  ...
  usePopupDomEvents$1(bindingList, { runtimeKey: "__AMCR_POPUP_RUNTIME__" });
}
function usePopupRuntimeMessages$1(options = {}) {
  const runtimeKey = options.runtimeKey || "__AMCR_POPUP_RUNTIME__";
...
function usePopupRuntimeMessages() {
  usePopupRuntimeMessages$1({ runtimeKey: "__AMCR_POPUP_RUNTIME__" });
}
function PopupPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-col popup-col--left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(QuickOpenSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LocalRegisterSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FindPageSection, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-col popup-col--right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RightPanelSection, {}) })
  ] });
}
function mountPopup() {
  ...
  root.render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PopupPage, {}) })
  );
}

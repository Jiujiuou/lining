...
function FormPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "ou-form-panel", "aria-label": "获取用户数据", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "ou-panel-title", children: "获取用户数据" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ou-form-fields", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "ou-form-label", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-form-label-text", children: "联盟/店铺 ID" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "ou-form-label", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-form-label-text", children: "搜索词" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ou-form-date-range", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "ou-form-label", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-form-label-text", children: "开始日期" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "date",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "ou-form-label", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-form-label-text", children: "结束日期" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "date",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "ou-form-label", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-form-label-text", children: "订单状态" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "ou-select",
            ...
            children: ORDER_STATUS_OPTIONS.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ou-form-actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: isStarting ? "正在启动…" : isRunning ? "获取中…" : "获取用户数据"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
function LogItem({ entry }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `ou-log-entry ou-log-entry--${level}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-log-time", children: time }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-log-message", children: message })
  ] });
}
function LogPanel({ logs, onClear }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "ou-log-panel", "aria-label": "日志", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "ou-log-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "ou-log-title", children: "日志" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "ou-log-clear", onClick: onClear, children: "清空" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ou-log-list", role: "log", "aria-live": "polite", children: logs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ou-log-empty", children: "暂无日志" }) : logs.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      LogItem,
      {
        entry
      },
...
function ProgressPanel({ progress }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ou-progress-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-progress-label", children: progress.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ou-progress-pages", children: progress.pages })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function addRuntimeListener(handler) {
  if (!hasRuntime() || !chrome.runtime.onMessage || typeof chrome.runtime.onMessage.addListener !== "function" || typeof handler !== "function") {
    return () => {
    };
  }
...
const ouLogger = createTabLogService({
...
async function readFormByTab(tabId) {
  if (tabId == null) {
    return getDefaultForm();
  }
  const result = await getLocalAsync([OU_STORAGE_KEYS.formByTab]);
  const byTab = result[OU_STORAGE_KEYS.formByTab] && typeof result[OU_STORAGE_KEYS.formByTab] === "object" ? result[OU_STORAGE_KEYS.formByTab] : {};
...
async function saveFormByTab(tabId, nextForm) {
  if (tabId == null) {
    return;
  }
  const result = await getLocalAsync([OU_STORAGE_KEYS.formByTab]);
...
function buildProgressState(message) {
...
function useOrderUserdataRuntimeMessages({
  appendLog,
  refreshLogs,
  setProgress,
  setIsRunning,
    ...
    const removeListener = addRuntimeListener((message) => {
      ...
      if (message.type === OU_RUNTIME.USER_DATA_DONE) {
        ...
        setProgress({
          ...
          pages: lastKnownTotalPageRef.current && lastKnownTotalPageRef.current > 0 ? `共 ${lastKnownTotalPageRef.current} 页` : "",
...
function useOrderUserdataFocusSync({ tabId, refreshAll, setForm }) {
  reactExports.useEffect(() => {
    const onFocus = () => {
      refreshAll();
...
async function startOrderUserdataJob(payload, callbacks = {}) {
  ...
  if (activeTab && activeTab.id != null && activeTab.url && OU_UI.QN_OR_TRADE_REG.test(activeTab.url)) {
    const result2 = await tryStartOnTab(activeTab.id, payload);
    if (result2.ok) {
      return { ok: true };
    }
    onError("无法与页面通信，请刷新已卖出订单页后重试");
    return { ok: false, error: normalizeErrorText(result2.error) };
  }
  ...
  if (existedTab && existedTab.id != null) {
    ...
    const result2 = await tryStartOnTab(existedTab.id, payload);
    if (result2.ok) {
      return { ok: true };
    }
    onError("无法与页面通信，请刷新已卖出订单页后重试");
...
async function stopOrderUserdataJob() {
  const activeTabs = await queryTabs({ active: true, currentWindow: true });
  const activeTab = activeTabs[0] || null;
...
function useOrderUserdataStartAction({
  form,
  isRunning,
  isStarting,
  setIsRunning,
  ...
  const onStop = reactExports.useCallback(async () => {
...
function useOrderUserdataPopupController() {
  const [form, setForm] = reactExports.useState(getDefaultForm);
  const [progress, setProgress] = reactExports.useState(getDefaultProgress);
  const [isStarting, setIsStarting] = reactExports.useState(false);
  const [isRunning, setIsRunning] = reactExports.useState(false);
  const lastKnownTotalPageRef = reactExports.useRef(null);
  ...
  const appendLog = reactExports.useCallback((level, message) => {
    if (level === "warn") {
  ...
  const setFormField = reactExports.useCallback(
    (field, value) => {
      setForm((prev) => {
        const next = {
          ...prev,
  ...
  const logsForView = reactExports.useMemo(() => {
...
function PopupPage() {
  const { form, progress, logs, isStarting, isRunning, setFormField, onStart, onStop, onClearLogs } = useOrderUserdataPopupController();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ou-popup-layout", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "ou-popup-layout-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FormPanel,
        {
          form,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressPanel, { progress })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "ou-popup-layout-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogPanel, { logs, onClear: onClearLogs }) })
  ] });
}
function mountPopup() {
  const container = document.getElementById("root");
  if (!container) {
    console.error("[Rext][extension-order-userdata] 未找到 #root，Popup 挂载失败");
    return;
  }

...
function initLegacyPopup() {
  if (globalThis.__LINING_SYCM_DETAIL_POPUP__) return;
  globalThis.__LINING_SYCM_DETAIL_POPUP__ = true;
    ...
    getActiveTabId(function(tabId) {
      ...
      chrome.storage.local.get([KEYS.liveJsonFilterByTab], function(r) {
        ...
        safeSet(
          ...
          function(retry) {
            byTab = common && typeof common.pruneByTabWithMeta === "function" ? common.pruneByTabWithMeta(
              byTab,
              FILTER_META_KEY,
  ...
  function renderGoodsList(items, itemIds) {
    ...
    if (lastCatalogItems.length === 0) {
      goodsListEl.innerHTML = '<div class="popup-findpage-list--empty"><span>暂无数据。请在生意参谋加载商品列表（触发 live.json）后点「刷新列表」。</span></div>';
    ...
    goodsListEl.innerHTML = lastCatalogItems.map(function(row, index) {
      ...
      return '<div class="popup-findpage-item" role="listitem" title="' + safeName + '"><input type="checkbox" id="goods-cb-' + index + '" data-item-id="' + safeId + '" aria-label="上报 ' + safeName + '"' + checkedAttr + ' /><label class="popup-findpage-name" for="goods-cb-' + index + '">' + safeName + '</label><span class="popup-goods-id">' + safeId + "</span></div>";
    }).join("");
  }
    ...
    chrome.storage.local.get(
      ...
      function(result) {
        getActiveTabId(function(tabId) {
          ...
          var cat = tabId != null && Object.prototype.hasOwnProperty.call(byCat, String(tabId)) ? byCat[String(tabId)] : result[KEYS.liveJsonCatalog];
          var filter;
      ...
      getActiveTabId(function(tabId) {
        chrome.storage.local.get(
          ...
          function(r) {
            ...
            var cat = tabId != null && Object.prototype.hasOwnProperty.call(byCat, String(tabId)) ? byCat[String(tabId)] : r[KEYS.liveJsonCatalog];
            var extra = "";
  ...
  function startLogPoll() {
    ...
    refreshInterval = setInterval(loadLogs, 3e4);
  }
  ...
  function handleRuntimeMessage(msg) {
    if (!msg || msg.type !== "SYCM_LOG_APPENDED") return;
    getActiveTabId(function(tabId) {
      if (msg.tabId == null || tabId == null || String(msg.tabId) === String(tabId)) {
        loadLogs();
      }
    });
  }
  function onGoodsRefresh() {
    sessionSelection = null;
    loadGoodsUi();
  }
  function onGoodsSelectAll() {
    setAllCheckboxes(true);
    syncSelectionFromDom();
  }
  function onGoodsSelectNone() {
    setAllCheckboxes(false);
    syncSelectionFromDom();
  }
  function onGoodsListChange(e) {
    var t = e && e.target;
  ...
  globalThis.__SYCM_DETAIL_POPUP_RUNTIME__ = {
    refreshAll,
...
function useLegacyPopupBootstrap() {
  reactExports.useEffect(() => {
    initLegacyPopup();
    const runtime = globalThis.__SYCM_DETAIL_POPUP_RUNTIME__;
...
function usePopupAutoRefresh() {
  usePopupAutoRefresh$1({ runtimeKey: "__SYCM_DETAIL_POPUP_RUNTIME__" });
}
...
function usePopupLogSync() {
  usePopupLogSync$1({ runtimeKey: "__SYCM_DETAIL_POPUP_RUNTIME__" });
}
...
function usePopupStorageSync() {
  usePopupStorageSync$1({ runtimeKey: "__SYCM_DETAIL_POPUP_RUNTIME__" });
}
...
function usePopupDomEvents() {
  ...
  usePopupDomEvents$1(bindingList, { runtimeKey: "__SYCM_DETAIL_POPUP_RUNTIME__" });
}
...
function usePopupRuntimeMessages() {
  usePopupRuntimeMessages$1({ runtimeKey: "__SYCM_DETAIL_POPUP_RUNTIME__" });
}
function PopupPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--goods", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-findpage-header popup-goods-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "goods-refresh", className: "popup-findpage-refresh", children: "刷新列表" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "goods-select-all", className: "popup-findpage-refresh", children: "全选" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "goods-select-none", className: "popup-findpage-refresh", children: "全不选" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "goods-save", className: "popup-open-sites", children: "保存设置" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "goods-meta", className: "popup-goods-meta", "aria-live": "polite" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-poll-controls", role: "group", "aria-label": "详情指标轮询", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-poll-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "popup-poll-label", htmlFor: "poll-interval-value", children: "轮询间隔" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-poll-interval", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "poll-interval-unit", className: "popup-poll-select", "aria-label": "轮询间隔单位", defaultValue: "min", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "sec", children: "秒" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "min", children: "分" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "hour", children: "时" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-poll-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "popup-poll-label", children: "并发" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-poll-readonly", "aria-label": "并发固定为 1", children: "1（固定）" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-poll-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "poll-start", className: "popup-open-sites", children: "开始采集详情" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "poll-stop", className: "popup-findpage-refresh", children: "停止" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "poll-meta", className: "popup-goods-meta", "aria-live": "polite" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "goods-list", className: "popup-findpage-list", role: "list" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "popup-section popup-section--logs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-logs-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "popup-logs-title", children: "扩展日志" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "logs-export", className: "popup-logs-clear", "aria-label": "复制扩展日志到剪贴板", children: "复制" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", id: "logs-clear", className: "popup-logs-clear", "aria-label": "清空扩展日志", children: "清空" })
      ] }),
